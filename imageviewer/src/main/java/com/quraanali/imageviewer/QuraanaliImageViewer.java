package com.quraanali.imageviewer;
...
import com.quraanali.imageviewer.viewer.builder.BuilderData;
import com.quraanali.imageviewer.viewer.dialog.ImageViewerDialog;
...
public class QuraanaliImageViewer<T> {

    private Context context;
    private BuilderData<T> builderData;
    private ImageViewerDialog<T> dialog;

    protected QuraanaliImageViewer(@NonNull Context context, @NonNull BuilderData<T> builderData) {
    ...
    public static class Builder<T> {
        ...
        public QuraanaliImageViewer<T> build() {
            return new QuraanaliImageViewer<>(context, data);
        }


        public QuraanaliImageViewer<T> show() {
            return show(true);
        }


        public QuraanaliImageViewer<T> show(boolean animate) {
            QuraanaliImageViewer<T> viewer = build();
            viewer.show(animate);
            return viewer;
        }
    }
